        ...
        if (!$this->helperData->versionCompare('2.3.0')) :
            if (!$installer->tableExists('mageplaza_blog_post')) {
                $table = $installer->getConnection()
                    ...
                    ->addColumn('post_position', Table::TYPE_TEXT, 255, ['nullable => true'], 'Post position') // mine
                    ->addColumn('post_brand_id', Table::TYPE_TEXT, 255, ['nullable => true'], 'Post brand id') // mine
                    ->addColumn('post_product_attachment', Table::TYPE_TEXT, 255, ['nullable => true'], 'Post product attachment') // mine
