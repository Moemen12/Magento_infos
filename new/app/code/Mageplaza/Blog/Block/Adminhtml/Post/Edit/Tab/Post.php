...
use Mageplaza\Blog\Model\Config\Source\Brands;
...
class Post extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('post_position', 'text', [ // mine
            'name'     => 'post_position',
            'label'    => __('Position'),
            'title'    => __('Position'),
            'required' => true
        ]); // mine end
        $fieldset->addField('post_brand_id', 'select', [ // mine
            'name'     => 'post_brand_id',
            'label'    => __('Brand ID'),
            'title'    => __('Brand ID'),
            'required' => false,
            'values'   => $this->_brands->toOptionArray()
        ]); // mine end
        $fieldset->addField('post_product_attachment', 'file', [ // mine product attachment
            'name'     => 'post_product_attachment',
            'label'    => __('Product attachment'),
