...
define(['jquery'], function ($) {
  ...
  $.widget('mageplaza.bannerslider', {
    ...
    loadTemplate: function loadTemplate() {
      var self = this;
      var toggleMCEEditor = $('#togglebanner_content'); // var bannerContent = $('#banner_content');
      ...
      btnLoadContent.on('click', function () {
        ...
        var html = tpl.replace(regEx, tplId); // if (bannerContent.css('display') === 'none') {
        //     toggleMCEEditor.trigger('click');
        // }
        // bannerContent.val(html);
      });
    },
    changeImageUrl: function changeImageUrl() {
