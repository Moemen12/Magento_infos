...
class Banner extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $BannerContent = $fieldset->addField('b_content', 'text', [ // mine
            'name' => 'b_content',
            'label' => __('Banner Content'),
            'title' => __('Banner Content'),
        ]);

        $BannerButton = $fieldset->addField('b_button', 'text', [ // mine
            'name' => 'b_button',
            'label' => __('Banner Button'),
            'title' => __('Banner Button'),
        ]);
        ...
        $dependencies = $this->getLayout()->createBlock(Dependence::class)
            ...
            ->addFieldMap($BannerContent->getHtmlId(), $BannerContent->getName()) // mine
            ->addFieldMap($BannerButton->getHtmlId(), $BannerButton->getName()) // mine
            ...
            ->addFieldDependence($BannerContent->getName(), $typeBanner->getName(), '0') // mine
            ->addFieldDependence($BannerButton->getName(), $typeBanner->getName(), '0') // mine
